    ...
    return (
        <footer className="select-none">
                ...
                <div className="flex flex-wrap justify-between gap-10">
                    <div className="mx-auto">
                        ...
                        <p className="max-w-[300px] mt-3 text-gray-200 text-justify">
                            ...
                            elit. Cum odio officiis velit tenetur amet minima
                            nemo ex suscipit, ipsum, itaque fugiat autem labore
                            deserunt mollitia inventore libero numquam cumque
                            illum.
                        </p>
                    </div>
            ...
            <section className="flex justify-center px-6 sm:px-12 md:px-20 py-2 bg-[#101010] text-zinc-500">
                <p>
                    Criado por{" "}
                    <span className="text-zinc-400 font-semibold">Dário</span> |
